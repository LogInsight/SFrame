...
if (APPLE)
ExternalProject_Add(ex_hdfs
  PREFIX ${CMAKE_SOURCE_DIR}/deps/hdfs
...
add_library(hdfs INTERFACE )
target_link_libraries(hdfs INTERFACE ${CMAKE_SOURCE_DIR}/deps/local/lib/libhdfs.so ${JVM_LIBRARY})
target_compile_definitions(hdfs INTERFACE HAS_HDFS)
target_compile_definitions(hdfs INTERFACE HAS_HADOOP) # legacy
set(HAS_HDFS TRUE CACHE BOOL "")
